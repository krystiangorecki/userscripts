...
function phoneSearchG2() {
    ...
    if (phoneInput != undefined && phoneInput.value.length == 9) {
        ...
        var newLink = document.createElement("span");
        newLink.innerHTML = ' <a href="' + url + '" style="   text-decoration: none;        text-align: center;    display: inline-block;    border-width: 2px;    border-style: solid;    border-color: red;   padding: 1px 2px;    " > g2 </a>';
